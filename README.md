...
- Step 2: Put all json file (contain correct answer) in `..\Courseraaa\input_folder` folder -> Run file `..\Courseraaa\main.py` -> Input file name subject with argument `--name` -> result in: `..\Courseraaa\output_folder`.
